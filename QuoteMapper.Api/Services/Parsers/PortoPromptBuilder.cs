...
public sealed class PortoPromptBuilder : IQuotePromptBuilder
{
    public string InsurerKey => "Porto";

    public string BuildPrompt(CoverageType coverageType)
    {
        return """
            Analise o documento PDF da cotação de seguro Porto Seguro e retorne SOMENTE um JSON válido.
            ...
            - O PDF Porto normalmente possui apenas um plano/orçamento principal.
            - Ignore o parâmetro CoverageType para Porto.
            ...
            - O código FIPE pode aparecer sem hífen, por exemplo "150908".
            ...
            - assistenciaGuincho = valor textual de "ASSISTÊNCIA KM ILIMITADO", por exemplo "KM ILIMITADO".
            ...
            REGRAS FINAIS:
            1. Use somente dados da cotação Porto Seguro.
